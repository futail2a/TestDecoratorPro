// -*- Java -*-
/*!
 * @file TestDecoratorProComp.java
...
/*!
 * @class TestDecoratorProComp
 * @brief Standalone component Class
 *
 */
public class TestDecoratorProComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(TestDecoratorPro.component_conf);
      mgr.registerFactory(prop, new TestDecoratorPro(), new TestDecoratorPro());

      // Create a component
      RTObject_impl comp = mgr.createComponent("TestDecoratorPro");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        TestDecoratorProComp init = new TestDecoratorProComp();
