// -*- Java -*-
/*!
 * @file  TestDecoratorProImpl.java
...
/*!
 * @class TestDecoratorProImpl
 * @brief ModuleDescription
 *
 */
public class TestDecoratorProImpl extends DataFlowComponentBase {

  /*!
   * @brief constructor
   * @param manager Maneger Object
   */
	public TestDecoratorProImpl(Manager manager) {  
        super(manager);
